  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-baseline gap-2 text-sm text-[#6B7280] mb-4">
        <Link
          href="/campaigns"
          className="hover:text-[#2563EB] transition-all duration-200"
        >
          Campaigns
        </Link>
        <span>/</span>
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href={`/campaigns/${id}/candidates`}
            className="px-4 py-2 text-sm font-medium text-[#4B5563] bg-white border border-[#D1D5DB] rounded-lg cursor-pointer hover:bg-[#F9FAFB] hover:text-[#111827] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB]"
          >
            Back to List
          </Link>
        </div>
        ...
        <div className="lg:col-span-1 space-y-6 min-w-0">
          ...
          <div className="bg-white rounded-xl border border-[#E5E7EB] p-5">
            ...
            <div className="space-y-3">
              ...
              >
                <svg
                  className="w-4 h-4 text-[#9CA3AF] shrink-0 group-hover:text-[#2563EB] transition-all duration-200"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <span className="text-sm text-[#4B5563] truncate group-hover:text-[#2563EB] transition-all duration-200">
                  {candidate.email}
                </span>
              </a>
              ...
              {candidate.phone && (
                ...
                >
                  ...
                  <span className="text-sm text-[#4B5563] group-hover:text-[#2563EB] transition-all duration-200">
                    {candidate.phone}
                  </span>
                </a>
              )}
              ...
              {candidate.linkedin_url && (
                ...
                >
                  ...
                  <svg
                    className="w-3 h-3 text-[#9CA3AF] shrink-0 group-hover:text-[#2563EB] transition-all duration-200"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {candidate.resume_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#374151] bg-white border border-[#D1D5DB] rounded-lg cursor-pointer hover:bg-[#F9FAFB] hover:text-[#111827] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB]"
                >
                  <svg
                    className="w-3.5 h-3.5"
                    fill="none"
              ...
              {hasResumeCriteria ? (
                ...
                <>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 mt-3 px-3 py-1.5 text-xs font-medium text-[#374151] bg-white border border-[#D1D5DB] rounded-lg cursor-pointer hover:bg-[#F9FAFB] hover:text-[#111827] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB]"
                  >
                    <svg
                      className="w-3.5 h-3.5"
                      fill="none"
