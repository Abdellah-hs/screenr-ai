 ...
 * with no evidence behind it — e.g. a "Screening Scored" application that was
 * never answered or scored. The system reaches these states only after the
 * real artifact is persisted (candidate responds → `screening_completed`;
 * scorer runs → `screening_scored`).
 *
