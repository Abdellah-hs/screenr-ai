    ...
    <header className="h-20 border-b border-[#E5E7EB] bg-[#FFFFFF] flex items-center justify-between px-8 z-10 sticky top-0">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3" title={`Signed in as ${email}`}>
          <div className="w-10 h-10 rounded-full bg-[#111827] text-white flex items-center justify-center font-bold text-sm tracking-wider">
            {initials}
          </div>
          <p className="hidden md:block text-sm font-semibold text-[#111827] truncate max-w-[200px]">
            {email}
          </p>
        </div>
